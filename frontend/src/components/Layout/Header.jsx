...
import { Menu, Search, Bell, Plus, Sun, Settings, ChevronDown } from "lucide-react";
...
function Header() {
  return (
    ...
    hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
      ...
      hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
          >
            {/* Icon Bell: Biểu tượng chính */}
            <Bell className="w-5 h-5" />

            {/* span: Dấu chấm thông báo (Badge) */}
            <span
      ...
      hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
        ...
        dark:border-slate-700"
          >
            <img
              src=" " // Thay thế bằng URL ảnh hợp lệ
              alt="User"
